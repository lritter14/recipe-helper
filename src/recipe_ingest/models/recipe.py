...
class RecipeMetadata(BaseModel):
    ...
    prep_time: str | None = Field(None, description="Preparation time (e.g., '15 minutes')")
    ...
    calories_per_serving: float | None = Field(None, description="Estimated calories", ge=0)
